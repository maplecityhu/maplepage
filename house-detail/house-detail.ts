...
export class HouseDetailPage implements OnInit {
  ...
  getRoomDesc(dc1, dc2, dc3) {
	...
	toggleF2M() {
		this.switchF2M = (this.switchF2M = HouseDetailPage.F2M.feet? HouseDetailPage.F2M.meter: HouseDetailPage.F2M.feet);	
}
